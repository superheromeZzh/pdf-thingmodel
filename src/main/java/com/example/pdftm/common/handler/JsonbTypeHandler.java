package com.example.pdftm.common.handler;
 ...
 *                  typeHandler="com.example.pdftm.common.handler.JsonbTypeHandler"/&gt;
 *   - 写入参数：#{model,jdbcType=OTHER,typeHandler=com.example.pdftm.common.handler.JsonbTypeHandler}
 *
 * 注意：
